...
public class CompilationTest extends TestCase {
  ...
  public void testImports() {
    ...
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoParcelGson_Baz(ints, arrays);",
        "  }",
        "}");
    JavaFileObject expectedOutput = JavaFileObjects.forSourceLines(
        "foo.bar.AutoParcelGson_Baz",
        ...
        "    if (o instanceof Baz) {",
        "      Baz that = (Baz) o;",
        "      return (Arrays.equals(this.ints, (that instanceof AutoParcelGson_Baz) "
                      + "? ((AutoParcelGson_Baz) that).ints : that.ints()))",
  ...
  public void testNoMultidimensionalPrimitiveArrays() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoParcelGson_Baz(ints);",
        "  }",
        "}");
    assertAbout(javaSource())
        .that(javaFileObject)
        .processedWith(new AutoParcelProcessor())
        .failsToCompile()
        .withErrorContaining("AutoParcelGson class cannot define an array-valued property "
  ...
  public void testNoObjectArrays() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoParcelGson_Baz(strings);",
        "  }",
        "}");
    assertAbout(javaSource())
        .that(javaFileObject)
  ...
  public void testAnnotationOnInterface() throws Exception {
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoParcelProcessor())
        .failsToCompile()
        .withErrorContaining("AutoParcelGson only applies to classes")
  ...
  public void testExtendAutoParcel() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "      return new AutoParcelGson_Outer_Parent(randomProperty);",
        "    }",
        "",
        ...
        "      return new AutoParcelGson_Outer_Child(randomProperty);",
        "    }",
        "",
        "    abstract int randomProperty();",
        "  }",
  ...
  public void testCannotImplementAnnotation() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoParcelGson_RetentionImpl(policy);",
        "  }",
        "",
  ...
  public void testCorrectBuilder() throws Exception {
    ...
    JavaFileObject expectedOutput = JavaFileObjects.forSourceLines(
        ...
        "          && (Arrays.equals(this.aByteArray, "
                    + "(that instanceof AutoParcelGson_Baz) "
                        + "? ((AutoParcelGson_Baz) that).aByteArray : that.aByteArray()))",
        "          && (Arrays.equals(this.aNullableIntArray, "
                    + "(that instanceof AutoParcelGson_Baz) "
                        + "? ((AutoParcelGson_Baz) that).aNullableIntArray : that.aNullableIntArray()))",
        ...
        "      }",
        "      Baz<T> result = new AutoParcelGson_Baz<T>(",
  ...
  public void testAutoParcelBuilderNotInsideAutoParcel() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoParcelGson_Baz.Builder();",
        "  }",
        "",
        "  @AutoParcelGson.Builder",
        "  public interface Builder {",
  ...
  public void testAutoParcelBuilderValidateMethodStatic() {
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoParcelProcessor(), new AutoParcelBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("@AutoParcelGson.Validate cannot apply to a static method")
        .in(javaFileObject).onLine(10);
  }
  ...
  public void testAutoParcelBuilderValidateMethodNotVoid() {
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoParcelProcessor(), new AutoParcelBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("@AutoParcelGson.Validate method must be void")
        .in(javaFileObject).onLine(10);
  }
  ...
  public void testAutoParcelBuilderValidateMethodWithParameters() {
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoParcelProcessor(), new AutoParcelBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("@AutoParcelGson.Validate method must not have parameters")
        .in(javaFileObject).onLine(10);
  }
  ...
  public void testAutoParcelBuilderValidateMethodDuplicate() {
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoParcelProcessor(), new AutoParcelBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("There can only be one @AutoParcelGson.Validate method")
        .in(javaFileObject).onLine(13);
  }
  ...
  public void testGetFooIsFoo() throws Exception {
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoParcelProcessor())
        .failsToCompile()
        .withErrorContaining("More than one @AutoParcelGson property called foo")
        .in(javaFileObject).onLine(8);
  }
  ...
  public void testReferencingGeneratedClass() {
    // Test that ensures that a type that does not exist can be the type of an @AutoParcelGson property
    ...
    JavaFileObject bazFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoParcelGson_Baz(barFoo);",
        "  }",
        "}");
