...
/**
 * Generates GWT serialization code for {@code @AutoParcelGson} classes also marked
...
class GwtSerialization {
  ...
  /**
   * Writes the GWT serializer for the given type, if appropriate. An {@code @AutoParcelGson} class gets
   ...
   * com.example.AutoParcelGson_Foo and the GWT serializer is
   * com.example.AutoParcelGson_Foo_CustomFieldSerializer.
   *
