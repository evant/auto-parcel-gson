 ...
 * the class with the {@code @AutoParcelGson} annotation, and we do just enough parsing of that code to
 ...
 * {@code @AutoParcelGson} constructor calls like {@code new AutoParcelGson_Foo(...)} suddenly start being
