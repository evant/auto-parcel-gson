...
final class TypeSimplifier {
  ...
  // If we have @AutoParcelGson abstract class Foo<T extends SomeClass> then this method will
  ...
  // If we have @AutoParcelGson abstract class Foo<T extends Something> then the subclass will be
  // final class AutoParcelGson_Foo<T extends Something> extends Foo<T>.
